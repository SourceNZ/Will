...
//		t.Tester(patientList2, ambulanceList2);
//		
//		
//		
//	}
...
//	}
//	public void Tester(ArrayList<Patient> patientList2, ArrayList<Ambulance> ambulanceList2) {
...
//		assign the closest unassigned patient to the ambulance and change the status to ‘Responding’. Otherwise, do nothing.		
		...
		if(pe != null || be != null){
			patientList2.remove(pe);
			ambulanceList2.remove(be);
		}
		System.out.println("THIS ONE Done!");
		for(Ambulance a : ambulanceList2){
			System.out.println(a);
		}
		System.out.println("Ambulances Done!");
	...
	public void save(ArrayList<Patient> patientList2, ArrayList<Ambulance> ambulanceList2){
		this.PatientList = patientList2;
		this.AmbulanceList = ambulanceList2;
	}
